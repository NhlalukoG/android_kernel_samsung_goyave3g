...
public class SJISSMModel extends SMModel {
    ...
    public SJISSMModel() {
        super(new PkgInt(INDEX_SHIFT_4BITS, SHIFT_MASK_4BITS, BIT_SHIFT_4BITS, UNIT_MASK_4BITS,
                sjisClassTable), SJIS_CLASS_FACTOR, new PkgInt(INDEX_SHIFT_4BITS, SHIFT_MASK_4BITS,
                BIT_SHIFT_4BITS, UNIT_MASK_4BITS, sjisStateTable), sjisCharLenTable,
    ...
    private static int[] sjisClassTable = new int[] {
            ...
            PkgInt.pack4bits(4, 4, 4, 4, 4, 0, 0, 0)
    // f8 - ff
    };
    ...
    private static int[] sjisStateTable = new int[] {
            ...
            PkgInt.pack4bits(ITSME, ITSME, ERROR, ERROR, START, START, START, START)
    // 10-17
    };
