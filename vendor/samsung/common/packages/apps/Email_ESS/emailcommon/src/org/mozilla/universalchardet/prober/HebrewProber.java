...
public class HebrewProber extends CharsetProber {
    ...
    protected static boolean isNonFinal(byte b) {
        ...
        // causing
        // the Non-Final tsadi to appear at an end of a word even though this is
        // not
        // the case in the original text.
        // The letters Pe and Kaf rarely display a related behavior of not being
        // a
        // good Non-Final letter. Words like 'Pop', 'Winamp' and 'Mubarak' for
        // example legally end with a Non-Final Pe or Kaf. However, the benefit
        // of
        // these letters as Non-Final letters outweighs the damage since these
        // words
        // are quite rare.
    }
}
