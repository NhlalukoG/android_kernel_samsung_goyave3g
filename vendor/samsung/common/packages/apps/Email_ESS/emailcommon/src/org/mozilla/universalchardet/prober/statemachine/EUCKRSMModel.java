...
public class EUCKRSMModel extends SMModel {
    ...
    public EUCKRSMModel() {
        super(new PkgInt(INDEX_SHIFT_4BITS, SHIFT_MASK_4BITS, BIT_SHIFT_4BITS, UNIT_MASK_4BITS,
                euckrClassTable), EUCKR_CLASS_FACTOR, new PkgInt(INDEX_SHIFT_4BITS,
                SHIFT_MASK_4BITS, BIT_SHIFT_4BITS, UNIT_MASK_4BITS, euckrStateTable),
                euckrCharLenTable, Constants.CHARSET_EUC_KR);
    }
