...
public class ISO2022JPSMModel extends SMModel {
    ...
    public ISO2022JPSMModel() {
        super(new PkgInt(INDEX_SHIFT_4BITS, SHIFT_MASK_4BITS, BIT_SHIFT_4BITS, UNIT_MASK_4BITS,
                iso2022jpClassTable), ISO2022JP_CLASS_FACTOR, new PkgInt(INDEX_SHIFT_4BITS,
                SHIFT_MASK_4BITS, BIT_SHIFT_4BITS, UNIT_MASK_4BITS, iso2022jpStateTable),
                iso2022jpCharLenTable, Constants.CHARSET_ISO_2022_JP);
    }
    ...
    private static int[] iso2022jpStateTable = new int[] {
            ...
            PkgInt.pack4bits(ERROR, ERROR, ERROR, ERROR, ITSME, ERROR, START, START)
    // 40-47
    };
