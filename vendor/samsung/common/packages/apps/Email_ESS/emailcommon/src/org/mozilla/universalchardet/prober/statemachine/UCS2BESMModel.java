...
public class UCS2BESMModel extends SMModel {
    ...
    public UCS2BESMModel() {
        super(new PkgInt(INDEX_SHIFT_4BITS, SHIFT_MASK_4BITS, BIT_SHIFT_4BITS, UNIT_MASK_4BITS,
                ucs2beClassTable), UCS2BE_CLASS_FACTOR, new PkgInt(INDEX_SHIFT_4BITS,
                SHIFT_MASK_4BITS, BIT_SHIFT_4BITS, UNIT_MASK_4BITS, ucs2beStateTable),
                ucs2beCharLenTable, Constants.CHARSET_UTF_16BE);
    }
    ...
    private static int[] ucs2beClassTable = new int[] {
            ...
            PkgInt.pack4bits(0, 0, 0, 0, 0, 0, 4, 5)
    // f8 - ff
    };
    ...
    private static int[] ucs2beStateTable = new int[] {
            ...
            PkgInt.pack4bits(6, 6, 6, 6, ERROR, ERROR, START, START)
    // 30-37
    };
