...
public class Big5SMModel extends SMModel {
    ...
    // //////////////////////////////////////////////////////////////
    public Big5SMModel() {
        super(new PkgInt(INDEX_SHIFT_4BITS, SHIFT_MASK_4BITS, BIT_SHIFT_4BITS, UNIT_MASK_4BITS,
                big5ClassTable), BIG5_CLASS_FACTOR, new PkgInt(INDEX_SHIFT_4BITS, SHIFT_MASK_4BITS,
                BIT_SHIFT_4BITS, UNIT_MASK_4BITS, big5StateTable), big5CharLenTable,
    ...
    private static int[] big5ClassTable = new int[] {
            ...
            PkgInt.pack4bits(1, 1, 1, 1, 1, 1, 1, 1), // 00 - 07 //allow 0x00 as
                                                      // legal value
            ...
            PkgInt.pack4bits(3, 3, 3, 3, 3, 3, 3, 0)
    // f8 - ff
    };
    ...
    private static int[] big5StateTable = new int[] {
            ...
            PkgInt.pack4bits(ERROR, START, START, START, START, START, START, START)
    // 10-17
    };
