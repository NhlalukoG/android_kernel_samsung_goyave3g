...
public class EUCJPSMModel extends SMModel {
    ...
    public EUCJPSMModel() {
        super(new PkgInt(INDEX_SHIFT_4BITS, SHIFT_MASK_4BITS, BIT_SHIFT_4BITS, UNIT_MASK_4BITS,
                eucjpClassTable), EUCJP_CLASS_FACTOR, new PkgInt(INDEX_SHIFT_4BITS,
                SHIFT_MASK_4BITS, BIT_SHIFT_4BITS, UNIT_MASK_4BITS, eucjpStateTable),
                eucjpCharLenTable, Constants.CHARSET_EUC_JP);
    }
    ...
    private static int[] eucjpClassTable = new int[] {
            ...
            PkgInt.pack4bits(0, 0, 0, 0, 0, 0, 0, 5)
    // f8 - ff
    };
    ...
    private static int[] eucjpStateTable = new int[] {
            ...
            PkgInt.pack4bits(3, ERROR, ERROR, ERROR, START, START, START, START)
    // 20-27
    };
