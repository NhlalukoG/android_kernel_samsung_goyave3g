...
public class EUCTWSMModel extends SMModel {
    ...
    public EUCTWSMModel() {
        super(new PkgInt(INDEX_SHIFT_4BITS, SHIFT_MASK_4BITS, BIT_SHIFT_4BITS, UNIT_MASK_4BITS,
                euctwClassTable), EUCTW_CLASS_FACTOR, new PkgInt(INDEX_SHIFT_4BITS,
                SHIFT_MASK_4BITS, BIT_SHIFT_4BITS, UNIT_MASK_4BITS, euctwStateTable),
    ...
    private static int[] euctwStateTable = new int[] {
            ...
            PkgInt.pack4bits(START, ERROR, START, START, START, START, START, START)
    // 28-2f
    };
