...
public class HZSMModel extends SMModel {
    ...
    public HZSMModel() {
        super(new PkgInt(INDEX_SHIFT_4BITS, SHIFT_MASK_4BITS, BIT_SHIFT_4BITS, UNIT_MASK_4BITS,
                hzsClassTable), HZS_CLASS_FACTOR, new PkgInt(INDEX_SHIFT_4BITS, SHIFT_MASK_4BITS,
                BIT_SHIFT_4BITS, UNIT_MASK_4BITS, hzsStateTable), hzsCharLenTable,
    ...
    private static int[] hzsStateTable = new int[] {
            ...
            PkgInt.pack4bits(4, ITSME, START, START, START, START, START, START)
    // 28-2f
    };
