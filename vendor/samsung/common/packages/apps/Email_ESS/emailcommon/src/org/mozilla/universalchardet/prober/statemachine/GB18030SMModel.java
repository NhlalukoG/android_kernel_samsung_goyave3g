...
public class GB18030SMModel extends SMModel {
    ...
    public GB18030SMModel() {
        super(new PkgInt(INDEX_SHIFT_4BITS, SHIFT_MASK_4BITS, BIT_SHIFT_4BITS, UNIT_MASK_4BITS,
                gb18030ClassTable), GB18030_CLASS_FACTOR, new PkgInt(INDEX_SHIFT_4BITS,
                SHIFT_MASK_4BITS, BIT_SHIFT_4BITS, UNIT_MASK_4BITS, gb18030StateTable),
                gb18030CharLenTable, Constants.CHARSET_GB18030);
    }
    ...
    private static int[] gb18030ClassTable = new int[] {
            ...
            PkgInt.pack4bits(6, 6, 6, 6, 6, 6, 6, 0)
    // f8 - ff
    };
    ...
    private static int[] gb18030StateTable = new int[] {
            ...
            PkgInt.pack4bits(ERROR, ERROR, START, START, START, START, START, START)
    // 28-2f
    };
