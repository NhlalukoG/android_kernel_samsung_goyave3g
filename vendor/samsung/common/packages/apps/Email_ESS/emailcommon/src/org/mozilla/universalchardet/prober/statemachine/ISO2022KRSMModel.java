...
public class ISO2022KRSMModel extends SMModel {
    ...
    public ISO2022KRSMModel() {
        super(new PkgInt(INDEX_SHIFT_4BITS, SHIFT_MASK_4BITS, BIT_SHIFT_4BITS, UNIT_MASK_4BITS,
                iso2022krClassTable), ISO2022KR_CLASS_FACTOR, new PkgInt(INDEX_SHIFT_4BITS,
                SHIFT_MASK_4BITS, BIT_SHIFT_4BITS, UNIT_MASK_4BITS, iso2022krStateTable),
                iso2022krCharLenTable, Constants.CHARSET_ISO_2022_KR);
    }
    ...
    private static int[] iso2022krStateTable = new int[] {
            ...
            PkgInt.pack4bits(ERROR, ERROR, ERROR, ITSME, START, START, START, START)
    // 20-27
    };
